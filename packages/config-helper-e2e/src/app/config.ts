...
export const config = createConfig({
	...
	database: {
		connectionUrl: stringParam({ defaultValue: 'my-db-server.example.org', matches: uriValidationRegex }), // Will be configurable via env-var 'DATABASE_CONNECTION_URL' and checked if it matches the given regex
